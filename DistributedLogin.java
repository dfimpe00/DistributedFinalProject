...
public class DistributedLogin {
	...
	public static void main(String[] args) {
		...
		System.out.println(readFile("pass.txt"));
		System.out.println(map.get("dax30"));
		System.out.println(encryptPass(map.get("dax30")));
		System.out.println(encryptPass(map.get("dax31")));
		System.out.println(readFile("pass.txt"));
		System.out.println(map.get("locke20"));
		System.out.println(checkPass("locke20","locke25"));
	}
	...
	public static boolean checkPass(String username, String passWord) {
		...
		readFile("pass.txt");
		String pass = readFile("pass.txt").get(username);
